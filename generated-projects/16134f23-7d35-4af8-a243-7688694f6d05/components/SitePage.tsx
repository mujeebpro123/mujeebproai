...
export default function SitePage({ pageKey }: { pageKey: PageKey }) {
  ...
  return (
    <div className="min-h-screen bg-[#070B19] text-slate-200 flex flex-col justify-between">
      {/* Header */}
      <header className="fixed top-0 w-full z-50 bg-[#070B19]/90 backdrop-blur-md border-b border-gold/10 shadow-lg">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="/" className={`${pageKey === 'home' ? 'text-gold' : 'text-slate-300 hover:text-gold'} transition font-medium`}>Home</a>
            <a href="/menu" className={`${pageKey === 'menu' ? 'text-gold' : 'text-slate-300 hover:text-gold'} transition font-medium`}>Menu</a>
            <a href="/gallery" className={`${pageKey === 'gallery' ? 'text-gold' : 'text-slate-300 hover:text-gold'} transition font-medium`}>Gallery</a>
            <a href="/about" className={`${pageKey === 'about' ? 'text-gold' : 'text-slate-300 hover:text-gold'} transition font-medium`}>About</a>
            <a href="/contact" className={`${pageKey === 'contact' ? 'text-gold' : 'text-slate-300 hover:text-gold'} transition font-medium`}>Contact</a>
          </div>
      ...
      <main className="flex-grow">
            ...
            <section id="signature" className="py-20 bg-[#0B132B]">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                  {coffees.map((coffee) => (
                    <div key={coffee.name} className="card-3d bg-[#0F172A] rounded-2xl overflow-hidden shadow-soft hover:shadow-gold">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {galleryImages.map((image, index) => (
                  <div key={index} className="card-3d rounded-2xl overflow-hidden shadow-soft hover:shadow-gold">
        ...
        {pageKey === 'about' && (
          <section className="pt-24 pb-20 bg-[#070B19]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="bg-about rounded-3xl p-10 md:p-16 shadow-soft">
        ...
        {pageKey === 'contact' && (
          <section className="pt-24 pb-20 bg-[#070B19]">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-[#0F172A] rounded-3xl p-8 md:p-12 shadow-soft border border-gold/10">
                {submitted ? (
                  ...
                  <form onSubmit={handleContactSubmit} noValidate className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-[#070B19] border border-slate-700 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-gold focus:ring-2 focus:ring-gold/30 transition-all duration-300"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-[#070B19] border border-slate-700 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-gold focus:ring-2 focus:ring-gold/30 transition-all duration-300 resize-none"
      ...
      {/* Footer */}
      <footer className="bg-[#0B132B] border-t border-gold/10 py-8">
