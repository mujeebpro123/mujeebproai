...
export default function SitePage({ pageKey }: { pageKey: PageKey }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0B132B] via-[#1E1B4B] to-[#0B132B] text-slate-200 flex flex-col justify-between">
      {/* Header */}
      <header className="fixed top-0 w-full z-50 bg-[#0B132B]/80 backdrop-blur-md border-b border-gold/10 shadow-lg">
          ...
          <>
            ...
            <section id="signature" className="py-24 bg-transparent">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                  {coffees.map((coffee) => (
                    <div key={coffee.name} className="card-3d glass-card rounded-2xl overflow-hidden shadow-soft hover:shadow-gold">
            ...
            <section className="py-20 bg-transparent">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-3 gap-8">
                {stats.map((stat) => (
                  <div key={stat.label} className="glass-card rounded-2xl p-8 text-center animate-float">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {galleryImages.map((image, index) => (
                  <div key={index} className="card-3d glass-card rounded-2xl overflow-hidden shadow-soft hover:shadow-gold">
